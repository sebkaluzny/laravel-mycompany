<template>
    <form v-on:submit.prevent="callback">
        <div class="ui equal width form" v-bind:class="{ 'loading': busy }">
            <div class="fields" v-if="fields.indexOf('name') !== -1">
                <div class="field">
                    <label>Nazwa</label>
            ...
            <div class="fields" v-if="fields.indexOf('size') !== -1">
                <div class="field">
                    <label>Grubość</label>
                    <input type="number" step="1" placeholder="Grubość" v-model="form.thickness">
                </div>
                <div class="field">
                    <label>Szerokość</label>
                    <input type="number" step="1" placeholder="Szerokość" v-model="form.width">
                </div>
                <div class="field">
                    <label>Długość</label>
                    <input type="number" step="1" placeholder="Długość" v-model="form.length">
                </div>
            </div>
...
<script type="text/ecmascript-6">
    export default{
        ...
        props: {
            fields: {
                type: Array,
                default: function () { return ['note', 'size', 'name'] }
            },
